...
public class StatisticalServlet extends HttpServlet {
     ...
     * @param request servlet request
     * @param response servlet response
     * @throws ServletException if a servlet- protected void
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        listNum = dao.numOfOrderEachMonth();
        ...
        request.setAttribute("t4", 0);
        request.setAttribute("t5", 0);
        request.setAttribute("t6", 0);
        request.setAttribute("t7", 0);
        request.setAttribute("t8", 0);
        request.setAttribute("t9", 0);
        request.setAttribute("t10", 0);
        request.setAttribute("t11", 0);
        request.setAttribute("t12", 0);
        for (String x : listNum) {
            String[] arr = x.split("\\,");         
                request.setAttribute("t"+arr[0].split("\\.")[0], arr[1]);  
